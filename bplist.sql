						...
						select                  'IGU_LIVE' +  convert(Varchar,a.docentry) id ,  
												...
												a.free_text   itext ,
                                                isnull(a.u_invoicing,'N')  invoicing ,
                                                isnull(a.u_printfp,'N') printfp ,
                                                isnull(A.U_PRINTFAKTUR,'Y') prinfaktur,
                                                isnull(A.U_PRINTKWITANSI,'Y') printkwitansi ,
                                                'DO Faktur : ' + isnull(a.u_invoicing,'N')  + char(10) + 
                                                'Print Faktur Pajak : ' + isnull(a.u_printfp,'N')  + char(10) + 
                                                '\n Print Faktur : ' + isnull(a.U_PRINTFAKTUR,'Y')  + char(10) + 
                                                '\n Print Kwitansi : ' + isnull(a.U_PRINTKWITANSI,'N')  + char(10)  istatusprint 
												from OCRD (NOLOCK) A   
